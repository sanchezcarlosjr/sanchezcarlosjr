...
I’m working with high-tech product companies to develop successful products, happy customers, and of course, to achieve their key results, as a full-stack developer -computer scientist, algorithms, database- with Git, React, Laravel, Python, PostgreSQL, Docker, Linux, and so on. My next step is to understand the world before transforming it. 
